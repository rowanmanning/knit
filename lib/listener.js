...
class Listener {
	 ...
	 * @param {Object} [options.help] - Help information for this listener.
	 * @param {String} [options.help.description] - A short description of the listener.
	 * @param {String} [options.help.emoji] - A Slack emoji name to use as an icon in the help output.
	 * @param {(String[]|String)} [options.help.examples] - An array of usage examples for the listener.
	 ...
	 * @throws {TypeError} Will throw if the help option is set without a description property.
	 */
	constructor(options) {
		...
		// Default all the help information
		this.help = this.options.help;
		if (this.help) {
			if (!this.help.description) {
				throw new TypeError(`${this.constructor.name} help.description must be set`);
			}
			if (!this.help.emoji || typeof this.help.emoji !== 'string') {
				this.help.emoji = 'speech_balloon';
			}
			this.help.examples = this.help.examples || [];
			if (!Array.isArray(this.help.examples)) {
				this.help.examples = [this.help.examples];
			}
		}
